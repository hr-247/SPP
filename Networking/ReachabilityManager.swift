...
class ReachabilityManager: NSObject {
    ...
    @objc func reachabilityChanged(notification: Notification) {
        ...
        case .notReachable:
            ...
            debugPrint("NoInternetKey".localizableString(loc: Constant.langPath))
            break
        case .reachableViaWiFi,.reachableViaWWAN:
            ...
            debugPrint("InternetconKey".localizableString(loc: Constant.langPath))
        }
    }
    ...
    func startMonitoring() {
        ...
        do{
            ...
            debugPrint("NotReachNotifyKey".localizableString(loc: Constant.langPath))
        }
    }
